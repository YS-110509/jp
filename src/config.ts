...
export const siteConfig: SiteConfig = {
	title: "芦花の部屋",
	subtitle: "芦花酱のブログ",
	siteURL: "https://jp.roka.ink/", // 请替换为你的站点URL，以斜杠结尾
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				...
				},
				{
					name: "X",
					icon: "mdi:twitter",
					url: "https://x.com/roka_sakurajima?s=11",
				},
				{
					name: "Instagram",
					icon: "mdi:instagram",
					url: "https://www.instagram.com/sakurajima_roka?igsh=OGgzaHBzZnNvaHdv",
				},
				{
					name: "youtube",
					icon: "mdi:youtube",
					url: "https://m.youtube.com/channel/UCbD0_nUBYpJX2-KSjPNt3zA",
				},
			],
		},
		{
...
export const profileConfig: ProfileConfig = {
	...
	name: "さくらじま ろか",
	bio: "美味しいものを味わっているときは、悩みなんて全部吹っ飛んでしまいます～",
	typewriter: {
...
export const announcementConfig: AnnouncementConfig = {
	title: "掲示板", // 公告标题，填空使用i18n字符串Key.announcement
	content:
		"BangumiはGFWによって隔離されているため、中国大陸のユーザーは視聴したアニメを見ることができず、万歳を理解することができない！", // 公告内容
